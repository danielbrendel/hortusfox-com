<div class="page-content margin-fix">
    ...
    <p class="is-font-mild">
        The dashboard provides you with locations, stats and other important information
    </p>
    ...
    <p class="is-font-mild">
        List all plants in a location and manage plant details
    </p>
    ...
    <p class="is-font-mild">
        Manage profile settings, exchange collaborative messages and much more!
    </p>
